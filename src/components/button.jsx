...
export const ButtonType = {
  solid:
    "text-gray-900 bg-primary-300 hover:bg-primary-400 active:bg-primary-500 transition ease-in-out duration-150",
  outline:
...
export function Button({
  ...
  return icon ? (
    <button
      type="button"
      className={`inline-flex space-x-2 justify-center items-center ${classNames} ${className}`}
    >
      {children}
      {icon}
    </button>
